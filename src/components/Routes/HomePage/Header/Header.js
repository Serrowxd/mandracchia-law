    ...
    return (
      <div>
        <Jumbotron fluid className="jumboColor">
          <div className="transHead_div">
            <h1 className="display-3 shift_right"> Looking For </h1>
            <h1 className="display-2 shift_right"> LEGAL </h1>
            ...
            <p className="lead shift_right">
              ...
              We handle Criminal Defense, Civil Litigation, Personal Injury,
              Real Estate, <br />
          ...
          <img src={img} class="img_header_att" alt="owo" />
        </Jumbotron>
      </div>
    );
  }
